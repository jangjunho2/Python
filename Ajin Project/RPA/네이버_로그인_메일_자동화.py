...
pyautogui.moveTo(98,258)  # 66번 줄 코드 오작동..
pyautogui.click()
time.sleep(2)
...
#보내기 버튼 클릭
send_btn=driver.find_element(By.CSS_SELECTOR,"#content > div.mail_toolbar.type_write > div:nth-child(1) > div > button.button_write_task")
send_btn.click()
time.sleep(2)
